...
<body>
    ...
    <div id="content-wrapper">
        <div class="bg-white p-4 rounded shadow-sm w-100">
            <h2 class="mb-4 text-center">Consulta de Almoxarifados</h2>
            ...
            <div class="w-100 d-flex justify-content-between align-items-center mb-3">
                ...
                <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4" id="categorias-container">
                            ...
                            <div class="card h-100 shadow-sm border-0">
                                <div class="card-body">
                                    <h5 class="card-title text-primary-emphasis">
                                        <i class="bi bi-building"></i> {{ $almoxarifado->nome }}
                                    </h5>
                                </div>
                            </div>
                        </div>
                    @empty
                        <div class="col-12">
                            <div class="alert alert-warning text-center">Nenhum almoxarifado encontrado.</div>
                        </div>
                    @endforelse
                </div>
            </div>
