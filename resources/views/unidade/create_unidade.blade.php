            ...
            <div class="card shadow-sm border-0">
                <div class="card-body">
                    <h3 class="card-title mb-4">
                        <i class="bi bi-plus-circle me-2"></i>Criar Nova Unidade
                    </h3>
                    ...
                    <form action="{{ route('create-unidade') }}" method="POST" class="row g-3">
                        @csrf
                        ...
                        <div class="col-md-4">
                            ...
                            <input placeholder="Ex: Kilograma" type="text" class="form-control" id="descricao" name="descricao" value="{{ old('descricao') }}">
                        </div>

                        <div class="col-12 mt-3">
                            <button type="submit" class="btn btn-success">
                                <i class="bi bi-check-circle me-1"></i>Salvar Unidade
                            </button>
                        </div>
